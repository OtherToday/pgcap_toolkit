...
This question into four requirements for a successful resource.  
...
![Strategic Design Framework](https://miro.medium.com/max/1400/0*wWy_y5_BgNz4TeXc)

In the research or *Explore* phase of the design process the Design Council advises that research should: 
...
An attempt to provide this resource has been undertaken with a "Learning Unit Repository" the idea for this is that the tutors record mini lectures in relation to the live work shopped sessions that can be viewed asychronously. The issue here however is that
...
The biggest insight from this interview was that Mystudies should be seen as a **signpost**. This means that you can use almost any platform and format so long as you point to it from Mystudies and have some document or text explaining where the teaching materials are. The Digital Enabled Learning Principles are principles to aim towards not a rule book to follow. This means that if my resource can meet the principles it would be an acceptable alternative. 
...
4. The major protoype has been the collation all of this into a Gitbook. This Gitbook is a collection of markdown files hosted on Github that are rendered as this HTML web page and possible to save as a PDF. 
...
1. I write offline with the application TYPORA which has a source code mode and a WYSIWYG view.
...
4. This can then be embed in TEAMS and MYSTUDIES in multiple ways
   1. [As an iframe or link to the whole gitbook or a specific page](https://github.com/OtherToday/pgcap_toolkit/blob/main/.gitbook/assets/PGAPtext.html)
   ...
   4. As a html file exported from typora
...
[^5]:  Council, W., 2021. SCULPT for Accessibility | Worcestershire County Council. [online] Worcestershire.gov.uk. Available at: https://www.worcestershire.gov.uk/sculpt [Accessed 7 November 2021].
